...
${GREEN}
=============(Script Auto instal: ARTA MAULANA)===============$wh"
echo -e ""
echo -e "\033[0;32m╒═════════════════════════════════════════════════════════════╕\033[0m${NC}"
echo -e " \E[41;1;39m                     ⇱ INFORMASI VPS ⇲                       \E[0m"
echo -e "\033[0;32m╘═════════════════════════════════════════════════════════════╛\033[0m${NC}"
echo -e "   ❄️️$bd ISP Name          ${color1} •${color3}$bd $ISP"
echo -e "   ❄️️$bd City              ${color1} •${color3}$bd $CITY"
echo -e "   ❄️️$bd Total RAM         ${color1} •${color3}$bd $tram MB"
echo -e "   ❄️️$bd IP VPS            ${color1} •${color3}$bd $MYIP"
echo -e "   ❄️️$bd DOMAIN VPS        ${color1} •${color3}$bd $DOMAIN"
echo -e "   ❄️️$bd Waktu Aktif       ${color1} •${color3}$bd $up"
echo -e "   ❄️️$bd Client Name       ${color1} •${color3}$bd ARTA VPN"
echo -e "   ❄️️$bd Expiry script     ${color1} •${color3}$bd LIFETIME"
echo -e "\033[0;32m╒═════════════════════════════════════════════════════════════╕\033[0m${NC}"
...
echo -e "
  ...
  [${GREEN}00${NC}]${color1} •${color3}$bd Back to exit Menu ${GREEN}<${yl}<\033[1;31m<\033[1;31m"
echo ""
echo -e "\033[0;32m╒═════════════════════════════════════════════════════════════╕\033[0m${NC}"
